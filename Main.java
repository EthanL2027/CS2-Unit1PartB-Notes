...
public class Main {
   ...
   public static void main(String []args) {
      ...
      Math.abs(-41); // works, but can't see the result
      ...
      // .equals() allows you to compare the content of two String objects
      ...
      // you can compare String vriable to a String LITERAL
